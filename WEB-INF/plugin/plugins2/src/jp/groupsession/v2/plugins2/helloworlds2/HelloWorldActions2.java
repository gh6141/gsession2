...
import java.util.Map;
  ...
  public class HelloWorldActions2 extends AbstractGsAction {
...
public ActionForward executeAction(ActionMapping map,
	  ...
	  tmp="";
     	 ...
     	 HelloWorldForms2 helloworldForms = (HelloWorldForms2)form;
...
try	{
	...
	String tmp3=TxtRead("/WEB-INF/plugin/newplugin/excel_path_s.txt");
