...
%>
  ...
  <td class="td_type1">
    ...
    <a href="javascript:void(0)" onClick="return folderView('view', '<bean:write name="cirMdl" property="cifSid" />', '<bean:write name="cirMdl" property="jsFlg" />');"><span class="<%= String.valueOf(titleFont) %>"><%= String.valueOf(sojuStr) %>&nbsp;<bean:write name="cirMdl" property="cifTitle" /></span></a>
  </td>
