...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_wt" width="100%">
      ...
      <div id="accountSelArea" class="account_name_area"><span id="selAccountNameArea"><bean:write name="cir120Form" property="cir120AccountName" /></span>　<input id="accountSelBtn" type="button" name="btn_add" class="btn_base1_7" value="<gsmsg:write key="wml.102" /><gsmsg:write key="cmn.select" />" ></div>
    </td>
    </tr>
